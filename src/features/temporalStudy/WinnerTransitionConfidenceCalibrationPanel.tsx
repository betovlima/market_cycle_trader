...
export function WinnerTransitionConfidenceCalibrationPanel({ study, runId, processingId, interventionSearch, canRun = false, showRunButton = true, refreshToken = 0, onChange }: AppRecord) {
