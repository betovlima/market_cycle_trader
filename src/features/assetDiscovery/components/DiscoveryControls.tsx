...
function StopIcon({ size = 16 }: AppRecord) {
...
function runMessage(run: AppRecord) {
...
export function DiscoveryControls({ run, active, busy, onStart, onStop, onRefresh, onExport }: AppRecord) {
