...
export function analyticsTimestamp(value: any) {
...
export function minimumAnalyticsZoomSpan(points: any[]) {
...
export function analyticsAxisLabel(value: any, visibleSpan: any) {
...
export function monthParts(value: any) {
  if (!value) return null
...
export function returnTone(value: any, epsilon: any = 1e-12) {
