...
export function TemporalMetric({ label, value, note = null, tone = '' }) {
  return (
...
export function LegacyHorizonTable({ items = [], selectedHorizon, onSelect }) {
  return (
...
export function ConfidenceTable({ items = [] }) {
...
export function LegacyForecastTable({ items = [] }) {
