...
export function pct(value: any, digits: any = 1) {
...
export function decimal(value: any, digits: any = 3) {
  if (value === null || value === undefined || Number.isNaN(Number(value))) return '—'
  return Number(value).toFixed(digits)
}

export function candidateLabel(candidate: AppRecord) {
...
export function numberOr(value: any, fallback: any = 0) {
