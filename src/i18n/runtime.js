...
const TRANSLATIONS = {
  en: {},
  pt: { ...PT_TRANSLATIONS, ...ASSET_STATE_PT_TRANSLATIONS, ...REVIEWER_ACCESS_PT_TRANSLATIONS, ...TEMPORAL_RESEARCH_PT_TRANSLATIONS },
  es: { ...ES_TRANSLATIONS, ...ASSET_STATE_ES_TRANSLATIONS, ...REVIEWER_ACCESS_ES_TRANSLATIONS, ...TEMPORAL_RESEARCH_ES_TRANSLATIONS },
}
