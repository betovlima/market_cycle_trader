...
const TRANSLATIONS = {
  en: {},
  pt: { ...PT_TRANSLATIONS, ...ASSET_STATE_PT_TRANSLATIONS, ...ASSET_DISCOVERY_PT_TRANSLATIONS, ...COMPLETION_NOTIFICATION_PT_TRANSLATIONS, ...REVIEWER_ACCESS_PT_TRANSLATIONS, ...STRATEGY_OPERATIONS_PT_TRANSLATIONS, ...TEMPORAL_RESEARCH_PT_TRANSLATIONS },
  es: { ...ES_TRANSLATIONS, ...ASSET_STATE_ES_TRANSLATIONS, ...ASSET_DISCOVERY_ES_TRANSLATIONS, ...COMPLETION_NOTIFICATION_ES_TRANSLATIONS, ...REVIEWER_ACCESS_ES_TRANSLATIONS, ...STRATEGY_OPERATIONS_ES_TRANSLATIONS, ...TEMPORAL_RESEARCH_ES_TRANSLATIONS },
}
